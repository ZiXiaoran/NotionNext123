...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '853860c97dfa42c6b076e057e98224d4,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '茈小染Baka', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '动漫 字幕 美图', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zixiaobakafanclub.top', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/672647144', // B站主页
  ...
  RANDOM_IMAGE_REPLACE_TEXT:
    ...
    'https://api.hanximeng.com/ranimg/api.php', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
